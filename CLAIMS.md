...
| C8 | H1: treatment-effect heterogeneity exists (visit, DR proxy, BLP per A1) | β₂ = 0.384 (se 0.039), p = 9.9e-23; survives Holm α/3 | `scripts/02_fit_cate.py` | `tests/test_gate_stage2.py`, notebook 02 | verified (Holm-final in Stage 5: significant at α/3) |
...
| C13 | H3(b): AIPW recovery of the confounding gap at γ\* | 93.7% [92.1%, 95.3%]; p_H3 = 4.5e-29 (IUT) | `scripts/03_how_wrong.py` | `tests/test_gate_stage3.py`, notebook 04 | verified (Holm-final in Stage 5: significant) |
